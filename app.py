...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Thuần - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0962 403 968</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Thuần - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0962 403 968</div>", unsafe_allow_html=True)
